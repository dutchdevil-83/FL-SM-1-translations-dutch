init python:
    class Nonogram(object):
        ...
        def get_button_image(self):
            if self.striked is False:
                if self.value == 0:
                    button_image = "images/minigames/nonogram/blocks/nonogram_block_idle.webp"
                elif self.value == 1:
                    button_image = "images/minigames/nonogram/blocks/nonogram_block_" + str(self.random_number) + ".webp"
            else:
                button_image = "images/minigames/nonogram/blocks/nonogram_block_empty.webp"
        ...
        def button_function(self):
            if self.striked is False:
                self.toggle_value()
                if self.value == 0:
                    renpy.play(audio.sfx_nonogram_black1, "sound3")
                elif self.value == 1:
                    renpy.play(Nonogram.get_random_click_sound(), "sound3")
            else:
                self.toggle_value()
                self.toggle_strike()
                renpy.play(audio.sfx_nonogram_green1, "sound3")
